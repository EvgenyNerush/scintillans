...
-- Here we test the dependence of the full probability rate *u* on *b* in classical (chi << 1)
...
-- *b*; however, being normalized to t_rf (that depend on *b*), *u* should not depend on b.
